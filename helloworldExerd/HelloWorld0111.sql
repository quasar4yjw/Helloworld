...
-- 국제화
DROP TABLE IF EXISTS I18N RESTRICT;
...
CREATE TABLE TOURISTS (
	...
	T_LANG   VARCHAR(50) NOT NULL COMMENT '여행객언어' -- 여행객언어
)
COMMENT '여행객';
...
CREATE TABLE NOTICE (
	...
	N_DATE  DATETIME      NOT NULL COMMENT '작성날짜', -- 작성날짜
...
CREATE TABLE QNA (
	...
	Q_DATE  DATETIME      NOT NULL COMMENT '질문날짜', -- 질문날짜
	A_CONT  VARCHAR(1000) NULL     COMMENT '답변내용', -- 답변내용
	A_DATE  DATETIME      NULL     COMMENT '답변날짜', -- 답변날짜
...
CREATE TABLE BOOK_INFO (
	...
	C_DATE  DATETIME     NOT NULL COMMENT '예약신청일', -- 예약신청일
	G_EMAIL VARCHAR(40)  NOT NULL COMMENT '가이드이메일', -- 가이드이메일
	T_EMAIL VARCHAR(40)  NOT NULL COMMENT '여행객이메일' -- 여행객이메일
)
COMMENT '예약정보';
...
CREATE TABLE ITEMS (
	...
	G_EMAIL VARCHAR(40)   NOT NULL COMMENT '가이드이메일', -- 가이드이메일
	PRICE   DECIMAL(30,2) NOT NULL COMMENT '금액' -- 금액
)
COMMENT '여행아이템';
...
CREATE TABLE MSG (
	...
	M_DATE  DATETIME     NOT NULL COMMENT '보낸날짜', -- 보낸날짜
...
CREATE TABLE REVIEWS (
	...
	R_DATE  DATETIME      NOT NULL COMMENT '리뷰날짜' -- 리뷰날짜
)
COMMENT '리뷰';
...
CREATE TABLE COMMENTS (
	...
	COM_DATE DATETIME     NOT NULL COMMENT '한줄평날짜', -- 한줄평날짜
...
-- 국제화
CREATE TABLE I18N (
	MSG_ID  VARCHAR(50)   NOT NULL COMMENT '페이지아이디', -- 페이지아이디
	LOCALE  VARCHAR(50)   NOT NULL COMMENT '로케일', -- 로케일
	MESSAGE VARCHAR(1000) NULL     COMMENT '메시지' -- 메시지
)
COMMENT '국제화';

-- 국제화
ALTER TABLE I18N
	ADD CONSTRAINT PK_I18N -- 국제화 기본키
		PRIMARY KEY (
			MSG_ID, -- 페이지아이디
			LOCALE  -- 로케일
		);
